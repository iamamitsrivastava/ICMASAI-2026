        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <Card className="p-8 glass-card mb-12">
              <h2 className="text-2xl font-bold mb-4 gradient-text">About the Conference</h2>
            ...
            <h2 className="text-3xl font-bold mb-8 text-center gradient-text">Conference Objectives</h2>
            ...
            <Card className="p-8 glass-card">
              <h2 className="text-2xl font-bold mb-4 gradient-text">Who Should Attend?</h2>
